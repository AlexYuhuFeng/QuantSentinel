...
This is a production-grade engineering project.

No experimental or loosely structured code is accepted.
...
- Modify only the files declared in the issue
- If additional files are required, update issue before proceeding
...
README must not describe capabilities that are not implemented.
